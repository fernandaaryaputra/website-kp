...
<head>
    ...
    <title>Edit Akta Kematian | Administrator</title>
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col pb-4">
            <main class="w-full flex-grow p-6">
                ...
                @endphp --}}
                    ...
                    <h1 class="text-3xl text-black pb-6 font-semibold">Edit Akte Kematian</h1>

                <div class="flex flex-wrap gap-20 px-5 mx-auto bg-[#C1C0C0] rounded-md shadow-md shadow-slate-700">
                   <form method="POST" class="grid md:grid-cols-2 w-full gap-10  auto-rows-max grid-cols-1 pt-7" enctype="multipart/form-data" action="{{ url('/administrator/update-akte-kematian/' . $aktekematian->id) }}">
                    @method('put')
                    @csrf
                    <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl">NIK</label>
                    <br>
                    <input type="text" name="nik" placeholder="nik" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" value="{{ $aktekematian->nik }}">
                    </div>
                    <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl">Nama Lengkap</label>
                    <br>
                    <input type="text" name="nama" placeholder="nama lengkap"  class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" value="{{ $aktekematian->nama }}">
                </div>
                <div class="col-span-2">
                    <label for="" class="text-2xl">Alamat</label>
                    <input type="text" name="alamat" placeholder="alamat" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" value="{{ $aktekematian->alamat }}">
                </div>
                <div class="col-span-2">
                    <label for="" class="text-2xl">Upload File</label>
                    <input type="file" class="bg-white p-2 form-control w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" id="pdf" name="pdf" accept="application/pdf" value="{{ $aktekematian->original_filename }}" value="{{ $aktekematian->original_filename }}" required>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="datetime-local" name="tanggallahir" id="tanggallahir" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" value="{{ $aktekematian->tanggallahir }}">
                    </div>
                    {{-- <input type="datetime"> --}}
