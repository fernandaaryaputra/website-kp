...
<head>
    ...
    <title>Menu Akta Kematian | Administrator</title>
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="pb-4 space-x-1 flex justify-between col-span-2 md:col-span-1">
                    <div class="text-black">
                        <form action="{{ url('/administrator/cari-akte-kematian') }}" method="GET">
                ...
                <table border="1" class="w-full bg-[#C1C0C0] rounded-md shadow-md shadow-slate-700 mb-20 text-center">
                    ...
                    <tbody class=" border border-white text-black text-base">
                        ...
                        <tr class="border border-white border-b-white">
                            ...
                            <td class="border border-white border-b-white"><a href="{{ url('administrator/download/'.$data->original_filename) }}" target="_blank"><button type="button" class="bg-cyan-700 hover:bg-green-700 text-white px-3 rounded-sm my-3">Download File</button></a></td>
                            <td class="border border-white border-b-white space-x-1">
                                ...
                                <a href="{{ url('/administrator/menu-akte-kematian/edit/'.$data->id) }}" class="bg-yellow-700 rounded-sm text-white px-3 py-1 hover:bg-yellow-900">Edit</a>
                                <a href="{{url('/administrator/menu-akte-kematian/delete/'.$data->id)}}" class="bg-red-700 rounded-sm text-white px-3 py-1 hover:bg-red-900">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
