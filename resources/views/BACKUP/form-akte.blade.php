...
<head>
    ...
    <title>Form Akta Kelahiran | Administrator</title>
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                {{-- <div class="text-end pb-4 space-x-1">
                    <a href="" class="bg-green-700 rounded-sm text-white px-3 py-1 hover:bg-green-900">Tambah Data</a>
                ...
                <div class="pb-4 space-x-1 flex justify-between col-span-2 md:col-span-1">
                    ...
                    <thead class="bg-slate-600 text-white border border-white font-semibold">
                        <tr class="border border-white border-b-white text-lg">
                            ...
                            <td class="border border-white border-b-white">NO KK</td>
                            <td class="border border-white border-b-white">NO NIK</td>
                    ...
                    <tbody class=" border border-white text-black text-base">
                        ...
                        <tr class="border border-white border-b-white">
                            ...
                            <td class="border border-white border-b-white space-x-1">
                                ...
                                <a href="" class="bg-yellow-700 rounded-sm text-white px-3 py-1 hover:bg-yellow-900">Edit</a>
                                <a href="" class="bg-red-700 rounded-sm text-white px-3 py-1 hover:bg-red-900">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <h1 class="text-3xl text-black pb-6 font-semibold">Form Akte Kelahiran</h1>
                <div class="flex flex-wrap gap-20 px-5 mx-auto bg-[#C1C0C0] rounded-md shadow-md shadow-slate-700">

                   <form method="POST" class="grid md:grid-cols-2 w-full gap-10  auto-rows-max grid-cols-1 pt-7">
                    @csrf
                    <div class="col-span-2 md:col-span-1">
                        <label for="" class="text-2xl">No KK</label>
                        <br>
                        <input type="text" name="kk" placeholder="no kk" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                        </div>
                    <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl">No NIK</label>
                    <br>
                    <input type="text" name="nik" placeholder="no nik" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                    </div>
                    <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="ayah" placeholder="nama ayah" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                    </div>
                    <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl"> Nama Ibu</label>
                    <br>
                    <input type="text" name="ibu" placeholder="nama ibu" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                    </div>
                    <div class="col-span-2 md:col-span-1">
