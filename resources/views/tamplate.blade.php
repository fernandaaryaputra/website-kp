...
<head>
    ...
    <title>Administrator Dashboard @yield('title')</title>
...
@endif
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="{{ url('/administrator/') }}" class="flex items-center  text-white py-4 pl-6 nav-item">
                <i class="fas fa-tachometer-alt mr-3"></i>
                Dashboard
            </a>
            <a href="{{ url('/administrator/menu') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav class="flex flex-col pt-4">
                <a href="{{ url('/administrator/') }}" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    <i class="fas fa-tachometer-alt mr-3"></i>
                    Dashboard
                </a>
                <a href="{{ url('/administrator/menu') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                    <i class="fas fa-sticky-note mr-3"></i>
                    Menu
                </a>
