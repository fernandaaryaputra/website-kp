...
<head>
    ...
    <title>Form Kartu Tanda Penduduk | Administrator</title>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col pb-4">
            <main class="w-full flex-grow p-6">
                ...
                <h1 class="text-3xl text-black pb-6 font-semibold">Form Kartu Tanda Penduduk</h1>
                ...
                <div class="flex flex-wrap gap-20 px-5 mx-auto bg-[#C1C0C0] rounded-md shadow-md shadow-slate-700">
                   <form method="POST" class="grid md:grid-cols-2 w-full gap-10  auto-rows-max grid-cols-1 pt-7" enctype="multipart/form-data">
                    ...
                    <br>
                    <input type="datetime-local" name="tanggallahir" placeholder="Tanggal lahir"  class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                    </div>
                    <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl">Jenis Kelamin</label>
                    <br>
                    <select name="jeniskelamin" id="jeniskelamin" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                ...
                <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl">Status Perkawinan</label>
                    <br>
                    <select name="statusperkawinan" id="statusperkawinan" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                        <option value="kawin">Kawin</option>
                        <option value="belum kawin">Belum Kawin</option>
                    </select>
                    </div>
                    <div class="col-span-2 md:col-span-1">
                    <label for="" class="text-2xl">Berlaku Hingga</label>
                    <br>
                    <input type="datetime-local" name="exp" placeholder="Tanggal Berlaku"  class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                </div>
                <div class="col-span-2 ">
                    <label for="" class="text-2xl">Agama</label>
                    <br>
                    <input type="text" name="agama" placeholder="agama" class="w-full h-12 mt-2 rounded-lg pl-2 shadow-lg">
                    </div>
                <div class="col-span-2">
                    <label for="" class="text-2xl">Upload Foto</label>
                    <input type="file" class="bg-white p-2 form-control w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" id="foto" name="foto" accept="application/foto" required>
                   
                </div>
                <div class="col-span-2">
                    <label for="" class="text-2xl">Upload Kartu Keluarga</label>
                    <input type="file" class="bg-white p-2 form-control w-full h-12 mt-2 rounded-lg pl-2 shadow-lg" id="dokumen" name="dokumen" accept="application/dokumen" required>
