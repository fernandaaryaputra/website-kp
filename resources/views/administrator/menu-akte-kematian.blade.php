@extends('tamplate')
@section('title', ' | Menu Akte Kematian')
@section('content')
...
<table border="1" class="w-full bg-[#C1C0C0] rounded-md shadow-md shadow-slate-700 mb-20 text-center">
    ...
    <tbody class=" border border-white text-black text-base">
        ...
        <tr class="border border-white border-b-white">
            ...
            <td class="border border-white border-b-white"><a href="{{ url('administrator/download/'.$data->id) }}" target="_blank"><button type="button" class="bg-cyan-700 hover:bg-green-700 text-white px-3 rounded-sm my-3">Download File</button></a></td>
